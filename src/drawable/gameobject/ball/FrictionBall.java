...
/**
 * Classe qui crée la balle qui ne rebondit pas et qui permet de montrer l'effet de la friction.
 * 
 * @author Alexandre Hua
 * @version 04-05-2015
 */
public class FrictionBall extends AbstractBall{
	public static final BufferedImage IMG = new BufferedImageLoader().loadImage("/game/frictionBall.png");
	public static final BufferedImage DISABLED_IMG = new BufferedImageLoader().loadImage("/game/frictionBall_disabled.png");
	 ...
	 */
	public FrictionBall(double x, double y, double diameter, double mass, AffineTransform worldMatrix, Handler handler, Camera cam) {
